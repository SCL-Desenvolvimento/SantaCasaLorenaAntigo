...
<div class="section-heading"><div><span class="eyebrow">ESPECIALIDADES</span><h2 id="specialties-title"><?= scl_cms_heading($specialtyContent['bloco1'] ?? '', 'Conheça nossas especialidades.') ?></h2><?= scl_cms_introduction($specialtyContent['bloco1'] ?? '') ?></div></div>
<?php if ($specialties): ?>
