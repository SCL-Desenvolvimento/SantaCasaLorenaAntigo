		...
		geocoder.geocode({ 'address': endereco, 'region': 'BR' }, function (results, status) {
			if (status == google.maps.GeocoderStatus.OK) {
				if (results[0]) {
					...
					endereco_formatado = results[0].formatted_address.replace(", Brasil", "");
					console.log(endereco_formatado);

					$('#txtEndereco').val(endereco_formatado);
