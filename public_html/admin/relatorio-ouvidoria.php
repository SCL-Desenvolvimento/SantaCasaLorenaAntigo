<?php
    ...
    $getOuvidoria->fullRead("SELECT C.* FROM ".PREFIX."ouvidoria AS C
                            WHERE ".(isset($data) && $data != "" ? $data : "")." C.id_ouvidoria > 0 ORDER BY C.data_cadastro DESC");
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
	...
	<?php				
		foreach ($getOuvidoria->getResult() AS $ouvidoria){
    ...
    <tr bgcolor="<?php echo $bg; ?>">
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['nome']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['email']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['cidade']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['assunto']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['razao']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo date("d/m/Y - H:i:s", strtotime($ouvidoria['data_cadastro'])); ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo $ouvidoria['mensagem']; ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
    </tr>
	<?php
		}
