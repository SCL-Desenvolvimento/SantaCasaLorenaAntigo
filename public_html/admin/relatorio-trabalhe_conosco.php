...
<table width="900" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="<?php echo $bg; ?>">
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo scl_report_text($trabalhe_conosco['nome']); ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo scl_report_text($trabalhe_conosco['email']); ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;<b><?php echo scl_report_text($trabalhe_conosco['cidade']); ?></b></td>
        <td bgcolor="<?php echo $bg; ?>">&nbsp;</td>
